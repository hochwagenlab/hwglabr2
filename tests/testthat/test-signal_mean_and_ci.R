...
output <- cbind(Mean=c(0.3308183, 0.8188403),
                 Lower=c(0.2292931, 0.6269228),
                 Upper=c(0.5057984, 0.9016770),
...
test_that('signal_mean_and_ci produces expected output matrix', {
  set.seed(42)
  testthat::expect_equal(strip_dimnames(signal_mean_and_ci(input, rep_bootstrap=10)),
...
test_that('elapsed_time throws error with object non-coercible to df', {
